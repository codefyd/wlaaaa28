...
لكل كافيه رابط باركود عام وثابت بصيغة
`https://loyalty.example.com/order.html#CAFE_ORDER_CODE`. يكتب العميل رقم جواله
في هذه الصفحة، ويتحقق برمز واتساب، ثم تظهر منتجات المحل ومكافآته في مكان واحد.
يمكن للعميل طلب مكافأة وحدها دون إضافة منتج مدفوع آخر.

- يدخل العميل حروف اللوحة الثلاثة في حقل مستقل، وأرقام اللوحة (2–4 أرقام)
  في حقل مستقل؛ ويتحقق الخادم من الصيغة قبل إنشاء الطلب.
- تعرض شاشة الكاشير الولاء وطلبات السيارة جنبًا إلى جنب على الشاشات الواسعة.
- يبدأ الطلب الجديد مباشرة بخطوة «بدء التحضير»، ثم «جاهز»، ثم «تسليم وتحصيل».
- «تسليم وتحصيل» يكمل الطلب، يسجل زيارة الولاء، ويفتح رسالة واتساب العميل.
- بعد تجهيز العميل من رقم جواله يستطيع الكاشير عرض باركود محلي لرابط العميل
  ذي الثمانية أحرف؛ مسحه يفتح صفحة العميل مباشرة، وتبقى حماية واتساب مطلوبة
  في الصفحات التي تتطلب تسجيل الدخول.
